...
<form class="cart grouped_form" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
    ...
    <?php $shipping_btn_url = get_post_meta($shop_id, 'gpf_shop_shipping', true);  ?>
    <a href="<?php echo $shipping_btn_url; ?>" class="btn-shipping" title="<?php _e('Haga click aqui para ver los costes de envío.', 'gespetfood'); ?>" target="_blank"></a>
