...
<head>
    ...
    <title>Gespetfood - Nuevo Mensaje de Mayorista</title> <!--   The title tag shows in email notifications, like Android 4.4. -->
    <link href='https://fonts.googleapis.com/css2?family=Didact+Gothic:wght@100;200;300&display=swap' rel='stylesheet' type='text/css'>
...
<![endif]-->
        ...
        <div style="max-height:0; overflow:hidden; mso-hide:all;" aria-hidden="true">
            Nuevo mensaje de Mayorista de {firstname} {lastname} - {email}
        </div>
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;  margin-bottom: 4em;">
                ...
                <tr>
                    <td style="padding: 40px 0; text-align: center">
                        <img src="{logo}" width="220" height="81" alt="Gespetfood" border="0" style="height: auto; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                    </td>
                </tr>
                <!-- Email Header : END -->
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    <h1 style=" text-align: center; margin: 0 0 10px 0; font-size: 25px; line-height: 30px; color: #333333; font-weight: bold;">Nuevo mensaje de Mayorista.</h1>
                                    <hr>
                                    <h4>Nombre: </h4>
