...
<head>
    ...
    <title>Gespetfood - Nuevo Mensaje de Contacto</title> <!--   The title tag shows in email notifications, like Android 4.4. -->
...
<![endif]-->
        ...
        <div style="max-height:0; overflow:hidden; mso-hide:all;" aria-hidden="true">
            Nuevo mensaje de contacto de {firstname} {lastname} - {email}
        </div>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    <h1 style=" text-align: center; margin: 0 0 10px 0; font-size: 25px; line-height: 30px; color: #333333; font-weight: bold;">Nuevo mensaje de contacto.</h1>
                                    <hr>
                                    <h4>Nombre: </h4>
